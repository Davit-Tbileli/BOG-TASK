...
class PromptTemplates:
    ...
    4. ახსენით რატომ არის თითოეული შეთავაზება სასარგებლო მათთვის
            ...
            კრიტიკული წესები სიზუსტისთვის:
        - თარიღებზე (როდიდან/როდემდე/პერიოდი) კითხვისას გამოიყენე მხოლოდ შეთავაზებაში მოცემული ველები:
            "პერიოდი: {start_date} - {end_date}" ან შესაბამისი სტრიქონები. არ გამოიგონო თარიღები.
            თუ თარიღი არ არის მოცემული, პირდაპირ თქვი რომ არ ჩანს და მიუთითე ბმული.

        - თუ მომხმარებელი კითხულობს დეტალებს შეთსახებ, აუცილებლად მიაწოდე ბმულიც.
